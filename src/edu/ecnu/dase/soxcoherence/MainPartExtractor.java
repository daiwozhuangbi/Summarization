...
public class MainPartExtractor
{
    ...
    private static LexicalizedParser lp;   //词汇解析器
    private static GrammaticalStructureFactory gsf;   //中文语法树
    static
    {
        String models = "models/chineseFactored.ser";        //模型
        LOG.info("载入文法模型：" + models);
        lp = LexicalizedParser.loadModel(models);
        TreebankLanguagePack tlp = new ChineseTreebankLanguagePack();        //汉语
